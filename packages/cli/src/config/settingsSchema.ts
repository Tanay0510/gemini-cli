  ...
  share: {
    ...
    properties: {
      enabled: {
        ...
        requiresRestart: false,
        default: true,
        description: 'Enable /share, /inbox, and /ask collaboration features.',
        showInDialog: true,
      },
      autoSyncDirectory: {
        type: 'boolean',
        label: 'Auto-Sync Team Directory',
        category: 'Advanced',
        requiresRestart: false,
        default: true,
        description:
          'Automatically refresh the list of teammates from your organization in the background.',
        showInDialog: true,
      },
      autoSyncInbox: {
        type: 'boolean',
        label: 'Check for New Shares on Startup',
        category: 'Team Collaboration',
        requiresRestart: false,
        default: true,
        description:
          'Check for new shared contexts from teammates when the CLI starts.',
        showInDialog: true,
      },
      showNotifications: {
        type: 'boolean',
        label: 'Notify on New Shares',
        category: 'Team Collaboration',
        requiresRestart: false,
        default: true,
        description:
          'Show a notification when a teammate shares context with you.',
        showInDialog: true,
      },
      myName: {
        type: 'string',
        ...
        default: undefined as string | undefined,
        description:
          'The name teammates will see when you share context (e.g. "alice"). ' +
          'Defaults to your Google account email or OS username if not set.',
        showInDialog: true,
      },
      teammates: {
        type: 'array',
        ...
        default: [] as string[],
        description:
          'Teammate names for tab-completion when using /share and /ask (e.g. ["bob", "carol"]).',
        showInDialog: true,
        items: { type: 'string' as const },
        mergeStrategy: MergeStrategy.UNION,
      },
      bucket: {
        type: 'string',
        label: 'Team Storage Location',
        category: 'Advanced',
        requiresRestart: false,
        default: undefined as string | undefined,
        description:
          'GCS bucket used to store shared contexts and team knowledge (e.g. "gs://my-team-bucket"). ' +
          'Leave empty to auto-discover based on your email domain.',
        emptyValueLabel: '(Auto-discovered)',
        showInDialog: true,
      },
      requireVerification: {
        type: 'boolean',
        label: 'Verified Identities Only',
        category: 'Advanced',
        requiresRestart: false,
        default: false,
        description:
          'Only allow sharing with teammates who have a verified identity (e.g. signed in with Google).',
        showInDialog: true,
      },
      allowedDomains: {
        type: 'array',
        ...
        default: [] as string[],
        description:
          'Limit sharing to specific email domains (e.g. ["google.com"]). Leave empty to allow any domain.',
        emptyValueLabel: '(Any domain)',
        showInDialog: true,
        items: { type: 'string' as const },
        mergeStrategy: MergeStrategy.UNION,
      },
      orgDirectoryCache: {
        type: 'array',
        label: 'Organization Directory Cache',
        category: 'Advanced',
        requiresRestart: false,
        default: [] as string[],
        description:
          'Cached list of teammates from the organization directory.',
        showInDialog: false,
        items: { type: 'string' as const },
        mergeStrategy: MergeStrategy.REPLACE,
      },
      lastSyncedAt: {
        ...
        requiresRestart: false,
        default: 0,
        description: 'Timestamp of the last successful background sync.',
        showInDialog: false,
      },
    },
  },
